...
export declare class BinaryObject {
     ...
     * @throws {IgniteClientError} if error.
     */
    getField(fieldName: any, fieldType?: any): Promise<object>;
    /**
     ...
     */
    getTypeName(): string;
    get fields(): Map<number, BinaryObjectField>;
    /**
     ...
     * @ignore
     */
    static _fromBuffer(communicator: BinaryCommunicator, buffer: MessageBuffer): Promise<BinaryObject>;
    /**
     * @ignore
     */
    _getHashCode(communicator: BinaryCommunicator): Promise<number>;
    /**
     * @ignore
     */
    _getTypeId(): number;
...
export declare class BinaryObjectField {
    ...
    get id(): number;
    get typeCode(): number;
    getValue(type?: any): Promise<object>;
    getOffsetType(headerStartPos: any): PRIMITIVE_TYPE.BYTE | PRIMITIVE_TYPE.SHORT | PRIMITIVE_TYPE.INTEGER;
    static _fromBuffer(communicator: BinaryCommunicator, buffer: MessageBuffer, offset: number, length: number, id: number): BinaryObjectField;
...
//# sourceMappingURL=BinaryObject.d.ts.map