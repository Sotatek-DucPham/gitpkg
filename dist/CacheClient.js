...
exports.AffinityHint = exports.CacheEntry = exports.CacheClient = void 0;
...
class CacheClient {
     ...
     */
    setKeyType(type) {
        BinaryUtils_1.default.checkObjectType(type, 'type');
        this._keyType = type;
        return this;
    }
    /**
    ...
    get(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyReadValueOp(BinaryUtils_1.default.OPERATION.CACHE_GET, key);
        });
    }
    /**
    ...
    getAll(keys) {
        return __awaiter(this, void 0, void 0, function* () {
            ArgumentChecker_1.default.notEmpty(keys, 'keys');
            ArgumentChecker_1.default.hasType(keys, 'keys', false, Array);
            let result = null;
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.CACHE_GET_ALL, (payload) => __awaiter(this, void 0, void 0, function* () {
    ...
    put(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._writeKeyValueOp(BinaryUtils_1.default.OPERATION.CACHE_PUT, key, value);
        });
    }
    /**
    ...
    putAll(entries) {
        return __awaiter(this, void 0, void 0, function* () {
            ArgumentChecker_1.default.notEmpty(entries, 'entries');
            ArgumentChecker_1.default.hasType(entries, 'entries', true, CacheEntry);
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.CACHE_PUT_ALL, (payload) => __awaiter(this, void 0, void 0, function* () {
                this._writeCacheInfo(payload);
    ...
    containsKey(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyReadBooleanOp(BinaryUtils_1.default.OPERATION.CACHE_CONTAINS_KEY, key);
        });
    }
    /**
    ...
    containsKeys(keys) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeysReadBooleanOp(BinaryUtils_1.default.OPERATION.CACHE_CONTAINS_KEYS, keys);
        });
    }
    /**
     * Associates the specified value with the specified key in the cache
    ...
    getAndPut(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyValueReadValueOp(BinaryUtils_1.default.OPERATION.CACHE_GET_AND_PUT, key, value);
        });
    }
    /**
     * Associates the specified value with the specified key in the cache
    ...
    getAndReplace(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyValueReadValueOp(BinaryUtils_1.default.OPERATION.CACHE_GET_AND_REPLACE, key, value);
        });
    }
    /**
    ...
    getAndRemove(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyReadValueOp(BinaryUtils_1.default.OPERATION.CACHE_GET_AND_REMOVE, key);
        });
    }
    /**
    ...
    putIfAbsent(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyValueReadBooleanOp(BinaryUtils_1.default.OPERATION.CACHE_PUT_IF_ABSENT, key, value);
        });
    }
    /**
     * Creates new entry (key-value pair) if the specified key does not exist in the cache.
    ...
    getAndPutIfAbsent(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyValueReadValueOp(BinaryUtils_1.default.OPERATION.CACHE_GET_AND_PUT_IF_ABSENT, key, value);
        });
    }
    /**
    ...
    replace(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyValueReadBooleanOp(BinaryUtils_1.default.OPERATION.CACHE_REPLACE, key, value);
        });
    }
    /**
    ...
    replaceIfEquals(key, value, newValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ArgumentChecker_1.default.notNull(key, 'key');
            ArgumentChecker_1.default.notNull(value, 'value');
            ArgumentChecker_1.default.notNull(newValue, 'newValue');
            let result;
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.CACHE_REPLACE_IF_EQUALS, (payload) => __awaiter(this, void 0, void 0, function* () {
                this._writeCacheInfo(payload);
    ...
    clear() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.CACHE_CLEAR, (payload) => __awaiter(this, void 0, void 0, function* () {
                this._writeCacheInfo(payload);
            }));
        });
    }
    ...
    clearKey(key) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._writeKeyOp(BinaryUtils_1.default.OPERATION.CACHE_CLEAR_KEY, key);
        });
    }
    /**
    ...
    clearKeys(keys) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._writeKeysOp(BinaryUtils_1.default.OPERATION.CACHE_CLEAR_KEYS, keys);
        });
    }
    /**
    ...
    removeKey(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyReadBooleanOp(BinaryUtils_1.default.OPERATION.CACHE_REMOVE_KEY, key);
        });
    }
    /**
    ...
    removeIfEquals(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._writeKeyValueReadBooleanOp(BinaryUtils_1.default.OPERATION.CACHE_REMOVE_IF_EQUALS, key, value);
        });
    }
    /**
    ...
    removeKeys(keys) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._writeKeysOp(BinaryUtils_1.default.OPERATION.CACHE_REMOVE_KEYS, keys);
        });
    }
    /**
    ...
    removeAll() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.CACHE_REMOVE_ALL, (payload) => __awaiter(this, void 0, void 0, function* () {
                this._writeCacheInfo(payload);
            }));
        });
    }
    ...
    getSize(...peekModes) {
        return __awaiter(this, void 0, void 0, function* () {
            ArgumentChecker_1.default.hasValueFrom(peekModes, 'peekModes', true, CacheClient.PEEK_MODE);
            let result;
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.CACHE_GET_SIZE, (payload) => __awaiter(this, void 0, void 0, function* () {
                this._writeCacheInfo(payload);
    ...
    query(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ArgumentChecker_1.default.notNull(query, 'query');
            ArgumentChecker_1.default.hasType(query, 'query', false, Query_1.SqlQuery, Query_1.SqlFieldsQuery, Query_1.ScanQuery);
            let value = null;
     ...
     * @ignore
     */
    _localPeek(socket, key, peekModes = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ArgumentChecker_1.default.notNull(key, 'key');
            let value = null;
            yield socket.sendRequest(BinaryUtils_1.default.OPERATION.CACHE_LOCAL_PEEK, (payload) => __awaiter(this, void 0, void 0, function* () {
                this._writeCacheInfo(payload);
    ...
    static _calculateId(name) {
        return BinaryUtils_1.default.strHashCode(name);
    }
    /**
     * @ignore
     */
    ...
    _writeKeyValueOp(operation, key, value, payloadReader = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._communicator.send(operation, (payload) => __awaiter(this, void 0, void 0, function* () {
                this._writeCacheInfo(payload);
                yield this._writeKeyValue(payload, key, value);
            }), payloadReader, this._createAffinityHint(key));
        });
    }
    /**
     * @ignore
...
class AffinityHint {
    constructor(cacheId, key, keyType) {
        this.cacheId = cacheId;
        this.key = key;
        this.keyType = keyType;
    }
}
exports.AffinityHint = AffinityHint;
