...
exports.CacheConfiguration = exports.QueryIndex = exports.INDEX_TYPE = exports.QueryField = exports.QueryEntity = exports.CacheKeyConfiguration = void 0;
...
class CacheKeyConfiguration {
    ...
    _write(communicator, buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            BinaryCommunicator_1.default.writeString(buffer, this._typeName);
            BinaryCommunicator_1.default.writeString(buffer, this._affinityKeyFieldName);
        });
    }
    /**
     * @ignore
    ...
    _read(communicator, buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            this._typeName = BinaryCommunicator_1.default.readString(buffer);
            this._affinityKeyFieldName = BinaryCommunicator_1.default.readString(buffer);
        });
    }
}
...
class QueryEntity {
    ...
    _write(communicator, buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            BinaryCommunicator_1.default.writeString(buffer, this._keyTypeName);
            BinaryCommunicator_1.default.writeString(buffer, this._valueTypeName);
            BinaryCommunicator_1.default.writeString(buffer, this._tableName);
            BinaryCommunicator_1.default.writeString(buffer, this._keyFieldName);
            BinaryCommunicator_1.default.writeString(buffer, this._valueFieldName);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (length > 0) {
                for (let [key, value] of this._aliases.entries()) {
                    BinaryCommunicator_1.default.writeString(buffer, key);
                    BinaryCommunicator_1.default.writeString(buffer, value);
                }
            }
        });
    }
...
class QueryField {
    ...
    setPrecision(precision) {
        ArgumentChecker_1.default.isInteger(precision, 'precision');
     ...
     */
    setScale(scale) {
        ArgumentChecker_1.default.isInteger(scale, 'scale');
        this._scale = scale;
        return this;
    }
    /**
    ...
    _write(communicator, buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            BinaryCommunicator_1.default.writeString(buffer, this._name);
            BinaryCommunicator_1.default.writeString(buffer, this._typeName);
...
var INDEX_TYPE;
(function (INDEX_TYPE) {
    INDEX_TYPE[INDEX_TYPE["SORTED"] = 0] = "SORTED";
    INDEX_TYPE[INDEX_TYPE["FULLTEXT"] = 1] = "FULLTEXT";
    INDEX_TYPE[INDEX_TYPE["GEOSPATIAL"] = 2] = "GEOSPATIAL";
})(INDEX_TYPE = exports.INDEX_TYPE || (exports.INDEX_TYPE = {}));
/**
...
class QueryIndex {
     ...
     */
    constructor(name = null, type = INDEX_TYPE.SORTED) {
        this._name = name;
        this.setType(type);
        this._inlineSize = -1;
        this._fields = null;
     ...
     */
    setType(type) {
        ArgumentChecker_1.default.hasValueFrom(type, 'type', false, QueryIndex.INDEX_TYPE);
        this._type = type;
        return this;
    }
    /**
...
const PROP_TYPES = Object.freeze({
    [PROP_NAME]: BinaryUtils_1.default.TYPE_CODE.STRING,
    [PROP_CACHE_MODE]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_ATOMICITY_MODE]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_BACKUPS]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_WRITE_SYNCHRONIZATION_MODE]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_COPY_ON_READ]: BinaryUtils_1.default.TYPE_CODE.BOOLEAN,
    [PROP_READ_FROM_BACKUP]: BinaryUtils_1.default.TYPE_CODE.BOOLEAN,
    [PROP_DATA_REGION_NAME]: BinaryUtils_1.default.TYPE_CODE.STRING,
    [PROP_IS_ONHEAP_CACHE_ENABLED]: BinaryUtils_1.default.TYPE_CODE.BOOLEAN,
    [PROP_QUERY_ENTITY]: new ObjectType_1.ObjectArrayType(new ObjectType_1.ComplexObjectType(new QueryEntity())),
    [PROP_QUERY_PARALLELISM]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_QUERY_DETAIL_METRICS_SIZE]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_SQL_SCHEMA]: BinaryUtils_1.default.TYPE_CODE.STRING,
    [PROP_SQL_INDEX_INLINE_MAX_SIZE]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_SQL_ESCAPE_ALL]: BinaryUtils_1.default.TYPE_CODE.BOOLEAN,
    [PROP_MAX_QUERY_ITERATORS]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_MODE]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_DELAY]: BinaryUtils_1.default.TYPE_CODE.LONG,
    [PROP_REBALANCE_TIMEOUT]: BinaryUtils_1.default.TYPE_CODE.LONG,
    [PROP_REBALANCE_BATCH_SIZE]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_BATCHES_PREFETCH_COUNT]: BinaryUtils_1.default.TYPE_CODE.LONG,
    [PROP_REBALANCE_ORDER]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_REBALANCE_THROTTLE]: BinaryUtils_1.default.TYPE_CODE.LONG,
    [PROP_GROUP_NAME]: BinaryUtils_1.default.TYPE_CODE.STRING,
    [PROP_CACHE_KEY_CONFIGURATION]: new ObjectType_1.ObjectArrayType(new ObjectType_1.ComplexObjectType(new CacheKeyConfiguration())),
    [PROP_DEFAULT_LOCK_TIMEOUT]: BinaryUtils_1.default.TYPE_CODE.LONG,
    [PROP_MAX_CONCURRENT_ASYNC_OPS]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_PARTITION_LOSS_POLICY]: BinaryUtils_1.default.TYPE_CODE.INTEGER,
    [PROP_EAGER_TTL]: BinaryUtils_1.default.TYPE_CODE.BOOLEAN,
    [PROP_STATISTICS_ENABLED]: BinaryUtils_1.default.TYPE_CODE.BOOLEAN
});
/**
 *
...
class CacheConfiguration {
    ...
    setAtomicityMode(atomicityMode) {
        ArgumentChecker_1.default.hasValueFrom(atomicityMode, 'atomicityMode', false, CACHE_ATOMICITY_MODE);
    ...
    setCacheMode(cacheMode) {
        ArgumentChecker_1.default.hasValueFrom(cacheMode, 'cacheMode', false, CACHE_MODE);
    ...
    setPartitionLossPolicy(partitionLossPolicy) {
        ArgumentChecker_1.default.hasValueFrom(partitionLossPolicy, 'partitionLossPolicy', false, PARTITION_LOSS_POLICY);
    ...
    setRebalanceMode(rebalanceMode) {
        ArgumentChecker_1.default.hasValueFrom(rebalanceMode, 'rebalanceMode', false, REABALANCE_MODE);
    ...
    setWriteSynchronizationMode(writeSynchronizationMode) {
        ArgumentChecker_1.default.hasValueFrom(writeSynchronizationMode, 'writeSynchronizationMode', false, WRITE_SYNCHRONIZATION_MODE);
    ...
    setKeyConfigurations(...keyConfigurations) {
        ArgumentChecker_1.default.hasType(keyConfigurations, 'keyConfigurations', true, CacheKeyConfiguration);
    ...
    setQueryEntities(...queryEntities) {
        ArgumentChecker_1.default.hasType(queryEntities, 'queryEntities', true, QueryEntity);
    ...
    _write(communicator, buffer, name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            buffer.position = buffer.position +
                BinaryUtils_1.default.getSize(BinaryUtils_1.default.TYPE_CODE.INTEGER) +
                BinaryUtils_1.default.getSize(BinaryUtils_1.default.TYPE_CODE.SHORT);
    ...
    _writeProperty(communicator, buffer, propertyCode, property) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (BinaryUtils_1.default.getTypeCode(propertyType)) {
