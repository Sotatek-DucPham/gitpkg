...
exports.SqlFieldsCursor = exports.Cursor = exports.BaseCursor = void 0;
    ...
    close() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._id && this._hasNext) {
                yield this._communicator.send(BinaryUtils_1.default.OPERATION.RESOURCE_CLOSE, (payload) => __awaiter(this, void 0, void 0, function* () {
...
class Cursor extends BaseCursor {
    ...
    _readRow(buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            return new CacheClient_1.CacheEntry(yield this._communicator.readObject(buffer, this._keyType), yield this._communicator.readObject(buffer, this._valueType));
        });
    }
}
 ...
 * @extends Cursor
 */
class SqlFieldsCursor extends BaseCursor {
    /** Private methods */
    /**
     * @ignore
     */
    constructor(communicator, buffer) {
        super(communicator, BinaryUtils_1.OPERATION.QUERY_SQL_FIELDS_CURSOR_GET_PAGE, buffer);
        this._fieldNames = [];
    }
    /**
