...
export declare class EnumItem {
     ...
     * @ignore
     */
    _read(communicator: BinaryCommunicator, buffer: MessageBuffer): Promise<void>;
    /**
     * @ignore
     */
    _getType(communicator: BinaryCommunicator, typeId: number): Promise<import("./internal/BinaryType").default>;
}
