...
class EnumItem {
     ...
     */
    setTypeId(typeId) {
        ArgumentChecker_1.default.isInteger(typeId, 'typeId');
        this._typeId = typeId;
        return this;
    }
    /**
     ...
     */
    setOrdinal(ordinal) {
        ArgumentChecker_1.default.isInteger(ordinal, 'ordinal');
     ...
     */
    setValue(value) {
        ArgumentChecker_1.default.isInteger(value, 'value');
        this._value = value;
        return this;
    }
    /** Private methods */
    ...
    _write(communicator, buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            const type = yield this._getType(communicator, this._typeId);
            if (!type || !type.isEnum) {
                throw Errors_1.IgniteClientError.enumSerializationError(true, Util.format('enum type id "%d" is not registered', this._typeId));
            }
            ...
            throw Errors_1.IgniteClientError.illegalArgumentError('Proper ordinal, name or value must be specified for EnumItem');
        });
    }
    /**
     * @ignore
    ...
    _read(communicator, buffer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const type = yield this._getType(communicator, this._typeId);
            if (!type || !type.isEnum) {
                throw Errors_1.IgniteClientError.enumSerializationError(false, Util.format('enum type id "%d" is not registered', this._typeId));
            }
            else if (!type.enumValues || type.enumValues.length <= this._ordinal) {
                throw Errors_1.IgniteClientError.enumSerializationError(false, 'type mismatch');
            }
     ...
     * @ignore
     */
    _getType(communicator, typeId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield communicator.typeStorage.getType(typeId);
        });
    }
}
