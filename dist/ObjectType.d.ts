 ...
 */
export declare enum MAP_SUBTYPE {
    HASH_MAP = 1,
    LINKED_HASH_MAP = 2
}
/**
...
export declare class MapObjectType extends CompositeType {
    ...
    private _keyType;
    private _valueType;
    static get MAP_SUBTYPE(): typeof MAP_SUBTYPE;
    /**
     * Public constructor.
     *
     ...
     */
    constructor(mapSubType?: MAP_SUBTYPE, keyType?: PRIMITIVE_TYPE | CompositeType, valueType?: PRIMITIVE_TYPE | CompositeType);
}
/**
 ...
 */
export declare enum COLLECTION_SUBTYPE {
    USER_SET = -1,
    USER_COL = 0,
    ARRAY_LIST = 1,
    LINKED_LIST = 2,
...
export declare class CollectionObjectType extends CompositeType {
    ...
    static get COLLECTION_SUBTYPE(): typeof COLLECTION_SUBTYPE;
    /**
     * Public constructor.
     *
     ...
     * @throws {IgniteClientError} if error.
     */
    constructor(collectionSubType: COLLECTION_SUBTYPE, elementType?: PRIMITIVE_TYPE | CompositeType);
    /** Private methods */
    /**
     * @ignore
     */
...
export declare class ObjectArrayType extends CompositeType {
     ...
     * @throws {IgniteClientError} if error.
     */
    constructor(elementType?: PRIMITIVE_TYPE | CompositeType);
}
/**
