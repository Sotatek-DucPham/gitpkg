...
exports.ComplexObjectType = exports.ObjectArrayType = exports.CollectionObjectType = exports.COLLECTION_SUBTYPE = exports.MapObjectType = exports.MAP_SUBTYPE = exports.CompositeType = exports.ObjectType = void 0;
...
class ObjectType {
    ...
    static get PRIMITIVE_TYPE() {
        return Constants_1.PRIMITIVE_TYPE;
    }
    static get COMPOSITE_TYPE() {
        return Constants_1.COMPOSITE_TYPE;
    }
    get typeCode() {
 ...
 */
var MAP_SUBTYPE;
(function (MAP_SUBTYPE) {
    MAP_SUBTYPE[MAP_SUBTYPE["HASH_MAP"] = 1] = "HASH_MAP";
    MAP_SUBTYPE[MAP_SUBTYPE["LINKED_HASH_MAP"] = 2] = "LINKED_HASH_MAP";
})(MAP_SUBTYPE = exports.MAP_SUBTYPE || (exports.MAP_SUBTYPE = {}));
/**
...
class MapObjectType extends CompositeType {
    ...
    constructor(mapSubType = MapObjectType.MAP_SUBTYPE.HASH_MAP, keyType = null, valueType = null) {
        super(Constants_1.COMPOSITE_TYPE.MAP);
        ArgumentChecker_1.default.hasValueFrom(mapSubType, 'mapSubType', false, MapObjectType.MAP_SUBTYPE);
        this._subType = mapSubType;
        BinaryUtils_1.default.checkObjectType(keyType, 'keyType');
        BinaryUtils_1.default.checkObjectType(valueType, 'valueType');
 ...
 */
var COLLECTION_SUBTYPE;
(function (COLLECTION_SUBTYPE) {
    COLLECTION_SUBTYPE[COLLECTION_SUBTYPE["USER_SET"] = -1] = "USER_SET";
    COLLECTION_SUBTYPE[COLLECTION_SUBTYPE["USER_COL"] = 0] = "USER_COL";
    COLLECTION_SUBTYPE[COLLECTION_SUBTYPE["ARRAY_LIST"] = 1] = "ARRAY_LIST";
    COLLECTION_SUBTYPE[COLLECTION_SUBTYPE["LINKED_LIST"] = 2] = "LINKED_LIST";
    COLLECTION_SUBTYPE[COLLECTION_SUBTYPE["HASH_SET"] = 3] = "HASH_SET";
    COLLECTION_SUBTYPE[COLLECTION_SUBTYPE["LINKED_HASH_SET"] = 4] = "LINKED_HASH_SET";
    COLLECTION_SUBTYPE[COLLECTION_SUBTYPE["SINGLETON_LIST"] = 5] = "SINGLETON_LIST";
})(COLLECTION_SUBTYPE = exports.COLLECTION_SUBTYPE || (exports.COLLECTION_SUBTYPE = {}));
/**
...
class CollectionObjectType extends CompositeType {
    ...
    constructor(collectionSubType, elementType = null) {
        super(Constants_1.COMPOSITE_TYPE.COLLECTION);
        ArgumentChecker_1.default.hasValueFrom(collectionSubType, 'collectionSubType', false, CollectionObjectType.COLLECTION_SUBTYPE);
        this._subType = collectionSubType;
        BinaryUtils_1.default.checkObjectType(elementType, 'elementType');
...
class ObjectArrayType extends CompositeType {
    ...
    constructor(elementType = null) {
        super(Constants_1.COMPOSITE_TYPE.OBJECT_ARRAY);
        BinaryUtils_1.default.checkObjectType(elementType, 'elementType');
        this._elementType = elementType;
    }
}
...
class ComplexObjectType extends CompositeType {
    ...
    constructor(jsObject, typeName = null) {
        super(Constants_1.COMPOSITE_TYPE.COMPLEX_OBJECT);
        ...
        for (let fieldName of BinaryUtils_1.default.getJsObjectFieldNames(this._template)) {
    ...
    setFieldType(fieldName, fieldType) {
        if (!this._fields.has(fieldName)) {
            throw Errors_1.IgniteClientError.illegalArgumentError(Util.format('Field "%s" is absent in the complex object type', fieldName));
        }
        BinaryUtils_1.default.checkObjectType(fieldType, 'fieldType');
