...
class BinaryTypeStorage {
    ...
    _getBinaryType(typeId) {
        return __awaiter(this, void 0, void 0, function* () {
            let binaryType = new BinaryType_1.default(null);
            binaryType.id = typeId;
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.GET_BINARY_TYPE, (payload) => __awaiter(this, void 0, void 0, function* () {
    ...
    _putBinaryType(binaryType) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!binaryType.isValid()) {
                throw Errors_1.IgniteClientError.serializationError(true, Util.format('type "%d" can not be registered', binaryType.id));
            }
            yield this._communicator.send(BinaryUtils_1.default.OPERATION.PUT_BINARY_TYPE, (payload) => __awaiter(this, void 0, void 0, function* () {
                yield binaryType._write(payload);
            }));
        });
    }
}
exports.default = BinaryTypeStorage;
