...
exports.TYPE_CODE = exports.OPERATION = void 0;
...
(function (OPERATION) {
    // Key-Value Queries
    OPERATION[OPERATION["CACHE_GET"] = 1000] = "CACHE_GET";
    OPERATION[OPERATION["CACHE_PUT"] = 1001] = "CACHE_PUT";
    OPERATION[OPERATION["CACHE_PUT_IF_ABSENT"] = 1002] = "CACHE_PUT_IF_ABSENT";
    OPERATION[OPERATION["CACHE_GET_ALL"] = 1003] = "CACHE_GET_ALL";
    OPERATION[OPERATION["CACHE_PUT_ALL"] = 1004] = "CACHE_PUT_ALL";
    OPERATION[OPERATION["CACHE_GET_AND_PUT"] = 1005] = "CACHE_GET_AND_PUT";
    OPERATION[OPERATION["CACHE_GET_AND_REPLACE"] = 1006] = "CACHE_GET_AND_REPLACE";
    OPERATION[OPERATION["CACHE_GET_AND_REMOVE"] = 1007] = "CACHE_GET_AND_REMOVE";
    OPERATION[OPERATION["CACHE_GET_AND_PUT_IF_ABSENT"] = 1008] = "CACHE_GET_AND_PUT_IF_ABSENT";
    OPERATION[OPERATION["CACHE_REPLACE"] = 1009] = "CACHE_REPLACE";
    OPERATION[OPERATION["CACHE_REPLACE_IF_EQUALS"] = 1010] = "CACHE_REPLACE_IF_EQUALS";
    OPERATION[OPERATION["CACHE_CONTAINS_KEY"] = 1011] = "CACHE_CONTAINS_KEY";
    OPERATION[OPERATION["CACHE_CONTAINS_KEYS"] = 1012] = "CACHE_CONTAINS_KEYS";
    OPERATION[OPERATION["CACHE_CLEAR"] = 1013] = "CACHE_CLEAR";
    OPERATION[OPERATION["CACHE_CLEAR_KEY"] = 1014] = "CACHE_CLEAR_KEY";
    OPERATION[OPERATION["CACHE_CLEAR_KEYS"] = 1015] = "CACHE_CLEAR_KEYS";
    OPERATION[OPERATION["CACHE_REMOVE_KEY"] = 1016] = "CACHE_REMOVE_KEY";
    OPERATION[OPERATION["CACHE_REMOVE_IF_EQUALS"] = 1017] = "CACHE_REMOVE_IF_EQUALS";
    OPERATION[OPERATION["CACHE_REMOVE_KEYS"] = 1018] = "CACHE_REMOVE_KEYS";
    OPERATION[OPERATION["CACHE_REMOVE_ALL"] = 1019] = "CACHE_REMOVE_ALL";
    OPERATION[OPERATION["CACHE_GET_SIZE"] = 1020] = "CACHE_GET_SIZE";
    OPERATION[OPERATION["CACHE_LOCAL_PEEK"] = 1021] = "CACHE_LOCAL_PEEK";
    // Cache Configuration
    OPERATION[OPERATION["CACHE_GET_NAMES"] = 1050] = "CACHE_GET_NAMES";
    OPERATION[OPERATION["CACHE_CREATE_WITH_NAME"] = 1051] = "CACHE_CREATE_WITH_NAME";
    OPERATION[OPERATION["CACHE_GET_OR_CREATE_WITH_NAME"] = 1052] = "CACHE_GET_OR_CREATE_WITH_NAME";
    OPERATION[OPERATION["CACHE_CREATE_WITH_CONFIGURATION"] = 1053] = "CACHE_CREATE_WITH_CONFIGURATION";
    OPERATION[OPERATION["CACHE_GET_OR_CREATE_WITH_CONFIGURATION"] = 1054] = "CACHE_GET_OR_CREATE_WITH_CONFIGURATION";
    OPERATION[OPERATION["CACHE_GET_CONFIGURATION"] = 1055] = "CACHE_GET_CONFIGURATION";
    OPERATION[OPERATION["CACHE_DESTROY"] = 1056] = "CACHE_DESTROY";
    OPERATION[OPERATION["CACHE_PARTITIONS"] = 1101] = "CACHE_PARTITIONS";
    // SQL and Scan Queries
    OPERATION[OPERATION["QUERY_SCAN"] = 2000] = "QUERY_SCAN";
    OPERATION[OPERATION["QUERY_SCAN_CURSOR_GET_PAGE"] = 2001] = "QUERY_SCAN_CURSOR_GET_PAGE";
    OPERATION[OPERATION["QUERY_SQL"] = 2002] = "QUERY_SQL";
    OPERATION[OPERATION["QUERY_SQL_CURSOR_GET_PAGE"] = 2003] = "QUERY_SQL_CURSOR_GET_PAGE";
    OPERATION[OPERATION["QUERY_SQL_FIELDS"] = 2004] = "QUERY_SQL_FIELDS";
    OPERATION[OPERATION["QUERY_SQL_FIELDS_CURSOR_GET_PAGE"] = 2005] = "QUERY_SQL_FIELDS_CURSOR_GET_PAGE";
    OPERATION[OPERATION["RESOURCE_CLOSE"] = 0] = "RESOURCE_CLOSE";
    // Binary Types
    OPERATION[OPERATION["GET_BINARY_TYPE"] = 3002] = "GET_BINARY_TYPE";
    OPERATION[OPERATION["PUT_BINARY_TYPE"] = 3003] = "PUT_BINARY_TYPE";
})(OPERATION = exports.OPERATION || (exports.OPERATION = {}));
exports.TYPE_CODE = Object.assign(Object.assign(Object.assign({}, Constants_1.PRIMITIVE_TYPE), Constants_1.COMPOSITE_TYPE), { BINARY_OBJECT: 27, BINARY_ENUM: 38 });
const TYPE_INFO = Object.freeze({
    [exports.TYPE_CODE.BYTE]: {
        NAME: 'byte',
        SIZE: 1
    },
    [exports.TYPE_CODE.SHORT]: {
        NAME: 'short',
        SIZE: 2
    },
    [exports.TYPE_CODE.INTEGER]: {
        NAME: 'integer',
        SIZE: 4
    },
    [exports.TYPE_CODE.LONG]: {
        NAME: 'long',
        SIZE: 8
    },
    [exports.TYPE_CODE.FLOAT]: {
        NAME: 'float',
        SIZE: 4
    },
    [exports.TYPE_CODE.DOUBLE]: {
        NAME: 'double',
        SIZE: 8
    },
    [exports.TYPE_CODE.CHAR]: {
        NAME: 'char',
        SIZE: 2
    },
    [exports.TYPE_CODE.BOOLEAN]: {
        NAME: 'boolean',
        SIZE: 1
    },
    [exports.TYPE_CODE.STRING]: {
        NAME: 'string',
        NULLABLE: true
    },
    [exports.TYPE_CODE.UUID]: {
        NAME: 'UUID',
        SIZE: 16,
        NULLABLE: true
    },
    [exports.TYPE_CODE.DATE]: {
        NAME: 'date',
        SIZE: 8,
        NULLABLE: true
    },
    [exports.TYPE_CODE.BYTE_ARRAY]: {
        NAME: 'byte array',
        ELEMENT_TYPE: exports.TYPE_CODE.BYTE,
        NULLABLE: true
    },
    [exports.TYPE_CODE.SHORT_ARRAY]: {
        NAME: 'short array',
        ELEMENT_TYPE: exports.TYPE_CODE.SHORT,
        NULLABLE: true
    },
    [exports.TYPE_CODE.INTEGER_ARRAY]: {
        NAME: 'integer array',
        ELEMENT_TYPE: exports.TYPE_CODE.INTEGER,
        NULLABLE: true
    },
    [exports.TYPE_CODE.LONG_ARRAY]: {
        NAME: 'long array',
        ELEMENT_TYPE: exports.TYPE_CODE.LONG,
        NULLABLE: true
    },
    [exports.TYPE_CODE.FLOAT_ARRAY]: {
        NAME: 'float array',
        ELEMENT_TYPE: exports.TYPE_CODE.FLOAT,
        NULLABLE: true
    },
    [exports.TYPE_CODE.DOUBLE_ARRAY]: {
        NAME: 'double array',
        ELEMENT_TYPE: exports.TYPE_CODE.DOUBLE,
        NULLABLE: true
    },
    [exports.TYPE_CODE.CHAR_ARRAY]: {
        NAME: 'char array',
        ELEMENT_TYPE: exports.TYPE_CODE.CHAR,
        NULLABLE: true
    },
    [exports.TYPE_CODE.BOOLEAN_ARRAY]: {
        NAME: 'boolean array',
        ELEMENT_TYPE: exports.TYPE_CODE.BOOLEAN,
        NULLABLE: true
    },
    [exports.TYPE_CODE.STRING_ARRAY]: {
        NAME: 'string array',
        ELEMENT_TYPE: exports.TYPE_CODE.STRING,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.DATE_ARRAY]: {
        NAME: 'date array',
        ELEMENT_TYPE: exports.TYPE_CODE.DATE,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.UUID_ARRAY]: {
        NAME: 'UUID array',
        ELEMENT_TYPE: exports.TYPE_CODE.UUID,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.OBJECT_ARRAY]: {
        NAME: 'object array',
        ELEMENT_TYPE: exports.TYPE_CODE.COMPLEX_OBJECT,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.COLLECTION]: {
        NAME: 'collection',
        NULLABLE: true
    },
    [exports.TYPE_CODE.MAP]: {
        NAME: 'map',
        NULLABLE: true
    },
    [exports.TYPE_CODE.BINARY_OBJECT]: {
        NAME: 'BinaryObject',
        NULLABLE: true
    },
    [exports.TYPE_CODE.ENUM]: {
        NAME: 'enum',
        NULLABLE: true
    },
    [exports.TYPE_CODE.ENUM_ARRAY]: {
        NAME: 'enum array',
        ELEMENT_TYPE: exports.TYPE_CODE.ENUM,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.DECIMAL]: {
        NAME: 'decimal',
        NULLABLE: true
    },
    [exports.TYPE_CODE.DECIMAL_ARRAY]: {
        NAME: 'decimal array',
        ELEMENT_TYPE: exports.TYPE_CODE.DECIMAL,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.TIMESTAMP]: {
        NAME: 'timestamp',
        NULLABLE: true
    },
    [exports.TYPE_CODE.TIMESTAMP_ARRAY]: {
        NAME: 'timestamp array',
        ELEMENT_TYPE: exports.TYPE_CODE.TIMESTAMP,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.TIME]: {
        NAME: 'time',
        NULLABLE: true
    },
    [exports.TYPE_CODE.TIME_ARRAY]: {
        NAME: 'time array',
        ELEMENT_TYPE: exports.TYPE_CODE.TIME,
        KEEP_ELEMENT_TYPE: true,
        NULLABLE: true
    },
    [exports.TYPE_CODE.NULL]: {
        NAME: 'null',
        NULLABLE: true
    },
    [exports.TYPE_CODE.COMPLEX_OBJECT]: {
        NAME: 'complex object',
        NULLABLE: true
    }
});
...
class BinaryUtils {
    ...
    static getTypeCode(type) {
        return type instanceof ObjectType_1.CompositeType ? type.typeCode : type;
    }
    static checkObjectType(type, argName) {
        if (type === null || type instanceof ObjectType_1.CompositeType) {
            return;
        }
        ArgumentChecker_1.default.hasValueFrom(type, argName, false, ObjectType_1.ObjectType.PRIMITIVE_TYPE);
    }
    static calcObjectType(object) {
        const objectType = typeof object;
        if (object === null) {
            throw Errors_1.IgniteClientError.unsupportedTypeError(BinaryUtils.TYPE_CODE.NULL);
        }
        ...
        else if (object instanceof Timestamp_1.Timestamp) {
            return BinaryUtils.TYPE_CODE.TIMESTAMP;
        }
        else if (object instanceof Date) {
            return BinaryUtils.TYPE_CODE.DATE;
        }
        else if (object instanceof EnumItem_1.EnumItem) {
            ...
            return new ObjectType_1.CollectionObjectType(ObjectType_1.CollectionObjectType.COLLECTION_SUBTYPE.HASH_SET);
        }
        else if (object instanceof Map) {
            return new ObjectType_1.MapObjectType();
        }
        else if (object instanceof BinaryObject_1.BinaryObject) {
            return BinaryUtils.TYPE_CODE.BINARY_OBJECT;
        }
        else if (objectType === 'object') {
            return new ObjectType_1.ComplexObjectType(object);
        }
    ...
    static checkCompatibility(value, type) {
        ...
        if (value === null) {
            if (!BinaryUtils.isNullable(typeCode)) {
                throw Errors_1.IgniteClientError.typeCastError(BinaryUtils.TYPE_CODE.NULL, typeCode);
            }
            return;
        }
        ...
        if (typeCode !== valueTypeCode) {
            throw Errors_1.IgniteClientError.typeCastError(valueTypeCode, typeCode);
        }
    }
        ...
        switch (typeCode) {
            ...
            case BinaryUtils.TYPE_CODE.LONG:
                if (!Number.isInteger(value)) {
                    throw Errors_1.IgniteClientError.valueCastError(value, typeCode);
                }
                return;
            ...
            case BinaryUtils.TYPE_CODE.ENUM:
                if (!(value instanceof EnumItem_1.EnumItem)) {
                    throw Errors_1.IgniteClientError.valueCastError(value, typeCode);
                }
                return;
            ...
            case BinaryUtils.TYPE_CODE.TIME_ARRAY:
                if (!(value instanceof Array)) {
                    throw Errors_1.IgniteClientError.typeCastError(valueType, typeCode);
                }
                return;
            ...
            case BinaryUtils.TYPE_CODE.COLLECTION:
                if (!(type && type._isSet() && value instanceof Set || value instanceof Array)) {
                    throw Errors_1.IgniteClientError.typeCastError(valueType, type && type._isSet() ? 'set' : typeCode);
                }
                return;
            case BinaryUtils.TYPE_CODE.NULL:
                if (value !== null) {
                    throw Errors_1.IgniteClientError.typeCastError('not null', typeCode);
                }
                return;
            default:
                const valueTypeCode = BinaryUtils.getTypeCode(BinaryUtils.calcObjectType(value));
    ...
    static checkTypesComatibility(expectedType, actualTypeCode) {
        ...
        if (actualTypeCode === BinaryUtils.TYPE_CODE.NULL) {
            ...
            throw Errors_1.IgniteClientError.typeCastError(actualTypeCode, expectedTypeCode);
        }
    }
    static getArrayElementType(arrayType) {
        if (arrayType instanceof ObjectType_1.ObjectArrayType) {
    ...
    static getArrayType(elementType) {
        switch (BinaryUtils.getTypeCode(elementType)) {
            ...
            case BinaryUtils.TYPE_CODE.BINARY_OBJECT:
                return new ObjectType_1.ObjectArrayType();
            default:
                return new ObjectType_1.ObjectArrayType(elementType);
        }
    }
    ...
    static hashCode(object, communicator, typeCode = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (BinaryUtils.isStandardType(typeCode)) {
                ...
                return yield object._getHashCode(communicator);
            }
        });
    }
