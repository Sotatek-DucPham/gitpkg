...
class MessageBuffer {
    ...
    writeByte(value) {
        this.writeNumber(value, BinaryUtils_1.default.TYPE_CODE.BYTE);
    }
    writeShort(value) {
        this.writeNumber(value, BinaryUtils_1.default.TYPE_CODE.SHORT);
    }
    writeInteger(value) {
        this.writeNumber(value, BinaryUtils_1.default.TYPE_CODE.INTEGER);
    }
    writeLong(value) {
        try {
            ...
            throw Errors_1.IgniteClientError.valueCastError(value, BinaryUtils_1.default.TYPE_CODE.LONG);
        }
        const buffer = Buffer.from(value.toBytesLE());
        this.writeBuffer(buffer);
    }
    writeFloat(value) {
        this.writeNumber(value, BinaryUtils_1.default.TYPE_CODE.FLOAT);
    }
    writeDouble(value) {
        this.writeNumber(value, BinaryUtils_1.default.TYPE_CODE.DOUBLE);
    }
    writeNumber(value, type, signed = true) {
        const size = BinaryUtils_1.default.getSize(type);
        ...
        try {
            ...
            throw Errors_1.IgniteClientError.valueCastError(value, type);
        }
        this._position += size;
    }
    writeBoolean(value) {
    ...
    writeString(value) {
        const buffer = Buffer.from(value, BinaryUtils_1.default.ENCODING);
    ...
    readByte() {
        return this.readNumber(BinaryUtils_1.default.TYPE_CODE.BYTE);
    }
    readShort() {
        return this.readNumber(BinaryUtils_1.default.TYPE_CODE.SHORT);
    }
    readInteger() {
        return this.readNumber(BinaryUtils_1.default.TYPE_CODE.INTEGER);
    }
    readLong() {
        const size = BinaryUtils_1.default.getSize(BinaryUtils_1.default.TYPE_CODE.LONG);
    ...
    readFloat() {
        return this.readNumber(BinaryUtils_1.default.TYPE_CODE.FLOAT);
    }
    readDouble() {
        return this.readNumber(BinaryUtils_1.default.TYPE_CODE.DOUBLE);
    }
    ...
    readString() {
        ...
        const result = this._buffer.toString(BinaryUtils_1.default.ENCODING, this._position, this._position + bytesCount);
    ...
    _ensureSize(size) {
        if (this._position + size > this._length) {
            throw Errors_1.IgniteClientError.internalError('Unexpected format of response');
        }
    }
